  ...
  <b-container class="bv-example-row mt-3">
    <div class="bgimg">
      <div class="row" id="signup-area">
        <div class="col-lg-6">
          <p class="font-weight-bold" id="signup" align="left">Sign-up</p>
          ...
          <form class="text-left mb-3" @submit.prevent="handleSubmit">
            ...
            <div class="form-group text-center">
              <button class="btn btn-primary btn-block mb-1">회원가입</button>
        ...
        <div class="col-lg-6">
          <img src="@/assets/Signup.png" id="signup-image" width="500px" />
        </div>
      </div>
    </div>
...
<script>
import { doubleCheck, join } from "@/api/member";
...
export default {
  ...
  methods: {
    idCheck() {
      ...
      if (this.ckid.length < 6 || this.ckid.length > 16) {
        this.idresult = `<div style="color: red">아이디는 6자이상 16자이하입니다.</div>`;
        this.isId = false;
      } else {
        doubleCheck(
          {
